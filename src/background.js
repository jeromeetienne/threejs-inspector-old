...
chrome.runtime.onConnect.addListener(function(port) {
        ...
        function onMessage(request){
                ...
                if( request.name === 'initInspector' ){
                        console.log('three.js inspector: create connection from devtools to tabId', request.tabId, request)
                        // console.assert(request.tabId !== undefined)
